    ...
    return (
        <div>
            ...
            <div className="four">
                ...
                <p>Application forms along with the prospectus will be available in the college office. OR <a href={admForm} download="Admission Form">Click Here to Download</a></p>
